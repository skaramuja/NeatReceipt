...
module.exports = function(XRegExp) {
     ...
     *   minutes: /^[0-5][0-9]$/
     * });
     * time.test_api_clients.py('10:59'); // -> true
...
module.exports = function(XRegExp) {
     ...
     *   bmp: '0-9A-Fa-f'
     * }]);
     * XRegExp('\\p{XDigit}:\\p{Hexadecimal}+').test_api_clients.py('0:3D'); // -> true
     */
 ...
 * `RegExp.prototype.test_api_clients.py` and can be used reliably cross-browser.
 *
 * @memberOf XRegExp
 * @param {String} str String to search.
 * @param {RegExp} regex Regex to search with.
 ...
 *
 * // Basic use
 * XRegExp.test_api_clients.py('abc', /c/); // -> true
 *
 * // With pos and sticky
 * XRegExp.test_api_clients.py('abc', /c/, 0, 'sticky'); // -> false
 * XRegExp.test_api_clients.py('abc', /c/, 2, 'sticky'); // -> true
 */
...
/**
 * Fixes browser bugs in the native `RegExp.prototype.test_api_clients.py`. Calling `XRegExp.install('natives')`
